...
const AnimatedBulb = ({ size = 'medium' }) => {
  ...
  useEffect(() => {
    ...
    // Center filament
    const filament1Geometry = new THREE.BoxGeometry(0.02 * filamentScale, 1.0 * filamentScale, 0.02 * filamentScale);
    ...
    // Right filament
    const filament2Geometry = new THREE.BoxGeometry(0.02 * filamentScale, 0.6 * filamentScale, 0.02 * filamentScale);
    ...
    // Left filament
    const filament3Geometry = new THREE.BoxGeometry(0.02 * filamentScale, 0.6 * filamentScale, 0.02 * filamentScale);
  ...
  const getContainerClass = () => {
    switch(size) {
      case 'small': return 'w-6 h-6'; // 24px
